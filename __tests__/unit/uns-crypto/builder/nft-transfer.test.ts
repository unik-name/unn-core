...
let builder: unsBuilders.NFTTransferBuilder;

describe("Business update builder", () => {
    Managers.configManager.setFromPreset("testnet");
    Transactions.TransactionRegistry.registerTransactionType(unsTransactions.NFTTransferTransaction);

    beforeEach(() => {
        builder = new unsBuilders.NFTTransferBuilder(TOKEN_ID);
    });
