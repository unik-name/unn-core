...
import { calculateApproval, calculateForgedTotal, toDecimal } from "./delegate-calculator";
...
export const delegateCalculator = { calculateApproval, calculateForgedTotal, toDecimal };
