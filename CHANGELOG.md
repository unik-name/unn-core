...
-   increase symbol max length

### Changed

-   restore original rate limit for peers.getBlocks
-   remove sandbox phase 2 milestone

## [5.7.1] - 2021-10-19

### Fixed

-   allow zero fee tx for org and network mints
...
-   Change UNS rewards amounts for Nft Mint ([#2978])
