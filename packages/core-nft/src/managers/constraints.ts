...
import { ConstraintError, constraints, IConstraint } from "../constraints";
import { IConstraintApplicationContext } from "../types";

interface INetworkConstraint {
    name: string;
    parameters: any;
}
...
export class ConstraintsManager {
    ...
    public async getAndApplyConstraints(context: IConstraintApplicationContext) {
    ...
    private getNetworkConstraints(propertyKey: string): INetworkConstraint[] {
        let constraints: INetworkConstraint[] = [];
