...
export const queries = {
    nfts: {
        ...
        searchNftsWithProperties: loadQueryFile(__dirname, "./nfts/nft-with-properties.sql"),
        ...
        findPropertyBatch: loadQueryFile(__dirname, "./nftproperties/findByKeyBatch.sql"),
        ...
        count: loadQueryFile(__dirname, "./nfts/count.sql"),
    },
};
